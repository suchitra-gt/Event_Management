        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="#services"
                        style="color: var(--pure-white) !important; font-weight: 600; text-transform: uppercase; font-size: 0.8rem; letter-spacing: 1px; margin: 0 10px;">Services</a>
                </li>
                <li class="nav-item"><a class="nav-link" href="#blogs"
                        style="color: var(--pure-white) !important; font-weight: 600; text-transform: uppercase; font-size: 0.8rem; letter-spacing: 1px; margin: 0 10px;">Portfolio</a>
                </li>
